...
class TestAttributes(TestCase):
    ...
    def test_attributtes(cls):
        ...
        cls.assertDictEqual(cls.doi.attributes.creators[0].to_dict(),{'name': 'Broecker, Wallace S', 'givenName': 'Wallace S', 'familyName': 'Broecker', 'affiliation': [], 'nameIdentifiers': ["{'schemeUri': 'https://orcid.org', 'nameIdentifier': 'https://orcid.org/0000-0003-4816-0903', 'nameIdentifierScheme': 'ORCID'}"]})
        cls.assertDictEqual(cls.doi.attributes.titles[0].to_dict(),{'title': 'Sedimentation rates calculated on surface sediment samples from different site of the Atlantic and Pacific Oceans (Table 1), supplement to: Broecker, Wallace S; Klas, Mieczyslawa; Clark, Elizabeth; Bonani, Georges; Ivy, Susan; Wolfli, Willy (1991): The influence of CaCO3 dissolution on core top radiocarbon ages for deep-sea sediments. Paleoceanography, 6(5), 593-608'})
        ...
        cls.assertDictEqual(cls.doi.attributes.types.to_dict(),{'ris': 'DATA', 'bibtex': 'misc', 'citeproc': 'dataset', 'schemaOrg': 'Dataset', 'resourceType': 'Supplementary Dataset', 'resourceTypeGeneral': 'Dataset'})
        ...
        cls.assertDictEqual(cls.doi.attributes.rightsList[0].to_dict(),{'rights': 'Creative Commons Attribution 3.0 Unported', 'rightsUri': 'https://creativecommons.org/licenses/by/3.0/legalcode', 'schemeUri': 'https://spdx.org/licenses/', 'rightsIdentifier': 'cc-by-3.0', 'rightsIdentifierScheme': 'SPDX'})
        cls.assertDictEqual(cls.doi.attributes.descriptions[1].to_dict(),{'description': 'depth is the apparent mixing depth, as determined by a downcore series of radiocarbon age', 'descriptionType': 'TechnicalInfo'})
        cls.assertListEqual(cls.doi.attributes.fundingReferences,["{'awardUri': 'https://cordis.europa.eu/project/rcn/47700/factsheet/en', 'awardTitle': 'Quaternary Environment of the Eurasian North', 'funderName': 'Fourth Framework Programme', 'awardNumber': 'MAS3980185', 'funderIdentifier': 'https://doi.org/10.13039/100011105', 'funderIdentifierType': 'Crossref Funder ID'}"])
