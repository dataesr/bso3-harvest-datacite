...
class TestAttributes(TestCase):
    ...
    def test_attributtes(cls):
        ...
        cls.assertDictEqual(
            cls.doi.data[0].attributes.creators[0].to_dict(),
            {
        ...
        cls.assertDictEqual(
            cls.doi.data[0].attributes.titles[0].to_dict(),
            {
        ...
        cls.assertDictEqual(
            cls.doi.data[0].attributes.types.to_dict(),
            {"ris": "DATA", "bibtex": "misc", "citeproc": "dataset", "schemaOrg": "Dataset", "resourceType": "Supplementary Dataset", "resourceTypeGeneral": "Dataset"},
        )
        cls.assertDictEqual(
            cls.doi.data[0].attributes.relatedIdentifiers[2].to_dict(), {"relationType": "References", "relatedIdentifier": "10.1017/s0033822200007542", "relatedIdentifierType": "DOI"}
        )
        ...
        cls.assertDictEqual(
            cls.doi.data[0].attributes.rightsList[0].to_dict(),
            {
        ...
        cls.assertDictEqual(
            cls.doi.data[0].attributes.descriptions[1].to_dict(),
        ...
        cls.assertListEqual(
            cls.doi.data[0].attributes.fundingReferences,
            [
